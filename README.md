...
My Task Was:
to analyse the telemetry data collected by Daikibo in a software called Tableau.
Download the daikibo-telemetry-data.json.zip file -> unzip -> and import it in Tableau. Double check that all Schema levels when i import my data.
...
Skills i learned in this simulation:-
Computer Networking, Data Analysis, Data Modeling, Data Structures, Data Visualization Tool(Tableau), Formal Communication, Log Analysis, Planning, Programming, Software Development, Spreadsheet Skills.
